...
display_names <- c(
  ...
  "Percent 25 Years and Older Population with Less than 9th Grade Education" = "percent_less_than_9th_grade",
  "Percent Total Population Identifying as White Alone" = "percent_white",
  "Percent Voting Age Population Identifying as Male" = "percent_male"
)
